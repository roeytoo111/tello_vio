...
public:
  ...
  */
  ...
  /**
  * @brief Get the last response string received from the drone.
  * @return Last response text (e.g., \"ok\", \"90\" for battery?).
  */
  std::string getLastResponse() const { return response_; }
